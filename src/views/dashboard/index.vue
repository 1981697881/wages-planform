...
-->
    ...
    <!--<el-row :gutter="32">
      <el-col :xs="24" :sm="24" :lg="12" style="padding: 0">
        <div class="chart-wrapper">
          <div style="padding: 11px 11px 11px 20px;display: flex">
            <el-switch
            ...
            <el-button type="text" size="mini">更多数据<i class="el-icon-d-arrow-right el-icon&#45;&#45;right"></i></el-button>
          </div>
          <raddar-chart/>
        </div>
      </el-col>
      <el-col :xs="24" :sm="24" :lg="12" style="padding: 0">
        <div class="chart-wrapper">
          <div style="padding: 5px;display: flex">
            <span style="flex: 1;">本月前10区域客户销售统计表</span>
            <el-button style="padding-right: 20px" type="text" size="mini">更多数据<i class="el-icon-d-arrow-right el-icon&#45;&#45;right"></i></el-button>
          </div>
          <zy-list ref="zyList"/>
        </div>
      </el-col>
    ...
    <el-row :gutter="32">
      ...
      <el-col :xs="24" :sm="24" :lg="12" style="padding: 0">
        <div class="chart-wrapper">
          <div style="padding: 5px;display: flex;">
            <span style="flex: 1">本月前10客户销售统计表</span>
            <el-button type="text" size="mini">更多数据<i class="el-icon-d-arrow-right el-icon&#45;&#45;right"></i></el-button>
            <span style="flex: 1">未发货统计表</span>
            <el-button style="padding-right: 20px" type="text" size="mini">更多数据<i class="el-icon-d-arrow-right el-icon&#45;&#45;right"></i></el-button>
          </div>
      ...
      fetchData(val) {
        ...
        if (interval > 100) {
          ...
          mainReport(val).then(res => {
            ...
            this.$nextTick(() => {
              this.$refs.zyLine.initChart({
                arrayDay: arrayDay,
                orderNum: orderNum,
                dopeYield: dopeYield,
                dopeDeliveryNum: dopeDeliveryNum
              })
            })
            this.$nextTick(() => {
              this.$refs.mcjLine.initChart({
                arrayDay: arrayDay,
                indentNum: indentNum,
                invPorcelainNum: invPorcelainNum,
                porcelainYield: porcelainYield,
                porcelainDeliveryNum: porcelainDeliveryNum
              })
            })
            this.loading = false
          })
