      ...
      <el-row :gutter="20">
        <el-col :span="24">
          <el-form-item :label="'分(次)值设定'">
            ...
            <el-table class="tableBox"  border height="250px" ref="multipleTable" stripe size="mini"  @selection-change="handleSelectionChange" :highlight-current-row="true" :data="form.datas" align="center" :cell-style="myclass" highlight-current-row>
  ...
  methods: {
    ...
    setRow() {
     /* this.postform = {
      ...
      var obj ={}
      for(var i = 1;i<3;i++){
        this.columns.push({ text: "分(次)值段"+ i, name: 'gpLevel'+i,sfkgg: false, sfcb: true})
        obj['gpLevel'+i] = ""
      }
