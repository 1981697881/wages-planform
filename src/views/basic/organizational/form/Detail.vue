  ...
  <div>
    <el-form :model="form" :rules="rules" ref="form" label-width="150px" :size="'mini'">
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="'上级部门'" prop="companyAddress">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="'部门负责人'" prop="telephone">
            <el-select v-model="form.telephone" placeholder="请选择">
              <el-option
                v-for="item in options"
                :key="item.value"
                :label="item.label"
