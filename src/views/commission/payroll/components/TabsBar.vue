    ...
    <el-form v-model="search" :size="'mini'">
      <el-button-group style="float:right">
        <!--<el-dropdown v-for="(t,i) in btnList" :key="i" v-if="t.category == 'multi'" @command="onFun(t.path, $event)" trigger="click">
         ...
         <el-button :size="'mini'" type="primary" icon="el-icon-plus" @click="handlerBtn('1')">新增</el-button>
          <el-button :size="'mini'" type="primary" icon="el-icon-edit" @click="handlerAlter('1')">修改</el-button>
          <el-button :size="'mini'" type="primary" icon="el-icon-delete" @click="handlerDel('1')">删除</el-button>
